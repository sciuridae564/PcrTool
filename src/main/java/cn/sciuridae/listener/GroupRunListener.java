...
public class GroupRunListener {
    ...
    public void createGroup(GroupMsg msg, MsgSender sender) {
        ...
        pcrUnion.setGroupMasterQQ(msg.getCodeNumber());
        pcrUnion.setTeamSum(1);

        TeamMember teamMember = new TeamMember();
        teamMember.setGroupQQ(msg.getGroupCodeNumber());
        teamMember.setUserQQ(msg.getCodeNumber());
    ...
    public void outGroup(GroupMsg msg, MsgSender sender) {
        ...
        if (pcrUnionServiceImpl.isGroupMaster(msg.getCodeNumber(), msg.getGroupCodeNumber())) {
            //会长退出销毁工会
            ...
            if (teamMemberServiceImpl.removeById(msg.getCodeNumber())) {
                pcrUnionServiceImpl.updateVoidSize(msg.getGroupCodeNumber());//更新空位信息
    ...
    public void changeSuperPower(GroupMsg msg, MsgSender sender) {
        ...
        Long groupByQQ = teamMemberServiceImpl.getGroupByQQ(msg.getCodeNumber());
    ...
    public void getToken(PrivateMsg msg, MsgSender sender) {
        ...
        String token = teamMemberServiceImpl.getToken(msg.getCodeNumber());
        if (token == null) {
    ...
    public void startHorse(PrivateMsg msg, MsgSender sender) {
        ...
        teamMemberServiceImpl.updateToken(msg.getCodeNumber(), token);
