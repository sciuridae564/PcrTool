...
public class constant {
    ...
    public static String[] noUpThree = {"杏奈", "真步", "璃乃", "初音", "依绪", "望", "妮胧", "秋乃", "真琴", "静流", "莫妮卡", "姬塔", "纯", "咲恋"};
    public static String[] noUptwo = {"紡希", "绫音", "茜里", "宫子", "雪", "铃奈", "香织", "美美", "惠理子", "忍", "真阳", "栞", "千歌", "空花", "珠希", "美冬", "深月", "铃"};
    public static String[] noUpone = {"胡桃", "铃莓", "日和莉", "怜", "未奏希", "依里", "由加莉", "碧", "美咲", "莉玛", "茉莉"};
    public static String[] Three_plus = {"冰川镜华"};
